...
*SU2 DataMiner* supports several types of flamelets to be included in the manifold. See :ref:`this page <flamelettypes>` for an overview of the currently supported types of flamelets.
The flamelet types in the configuration can be accessed through the following functions:

.. autofunction:: Common.DataDrivenConfig.Config_FGM.includeFlameletType 

.. autofunction:: Common.DataDrivenConfig.Config_FGM.excludeFlameletType 

.. autofunction:: Common.DataDrivenConfig.Config_FGM.setFlameletTypes 

.. autofunction:: Common.DataDrivenConfig.Config_FGM.getFlameletTypes 
